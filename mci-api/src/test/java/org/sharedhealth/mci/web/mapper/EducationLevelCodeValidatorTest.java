...
public class EducationLevelCodeValidatorTest extends BaseCodeValidatorTest<PatientMapper> {

    @Test
    public void shouldPassForValidValues() throws Exception {
        String[] validStatuses = {"00", "01", "19"};
        assertValidValues(validStatuses, "educationLevel", PatientMapper.class);
    }

    @Test
    public void shouldFailForInvalidValues() throws Exception {
        String[] inValidRelations = {"", "some_invalid_code", "4", "20"};
        assertInvalidValues(inValidRelations, "educationLevel", PatientMapper.class);
    }
}