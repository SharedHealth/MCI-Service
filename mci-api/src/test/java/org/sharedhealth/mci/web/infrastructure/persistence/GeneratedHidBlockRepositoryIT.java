...
public class GeneratedHidBlockRepositoryIT extends BaseIntegrationTest {
    ...
    public void shouldInsertAHIDBlock() throws Exception {
        GeneratedHIDBlock hidBlockToInsert = new GeneratedHIDBlock(9100L, "MCI", 9100L, 9150L, 10L, null, TimeUuidUtil.uuidForDate(new Date()));
    ...
    public void shouldRetrieveAHIDBlockBySeriesNo() throws Exception {
        GeneratedHIDBlock hidBlock1 = new GeneratedHIDBlock(9100L, "MCI", 9100L, 9150L, 10L, null, TimeUuidUtil.uuidForDate(new Date()));
        GeneratedHIDBlock hidBlock2 = new GeneratedHIDBlock(9200L, "MCI", 9200L, 9250L, 10L, null, TimeUuidUtil.uuidForDate(new Date()));
        GeneratedHIDBlock hidBlock3 = new GeneratedHIDBlock(9100L, "MCI", 9151L, 9199L, 10L, null, TimeUuidUtil.uuidForDate(new Date()));
